<?php 
   include('design_website/header.php');
?>
    <!-- Page Preloder -->
    <!-- <div id="preloder">
                        ...
                        <div class="leave-comment">
                            ...
                            <form  class="comment-form">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" name="m_title"  placeholder="Subject" id="m_title">
                                    </div>
                                    <div class="col-lg-12">
